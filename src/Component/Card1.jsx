...
export default function Card1(props) {
  return (
   ...
   <img  src={`img/${props.info.img}`} className="w-10/12  dark:invert-0" alt="" />
    ...
    <p className="text-xs md:text-xl font-bold">Starting at N{props.info.price}/Day</p>
    ...
    <button className='px-4 py-2 bg-red-700 hover:bg-gray-950 hover:border-transparent hover:text-gray-50 dark:bg-red-800 dark:text-gray-50 dark:hover:bg-gray-950 dark:hover:text-gray-50    transition ease-in-out  delay-150 duration-300 text-white rounded-lg'>Book Now</button>
